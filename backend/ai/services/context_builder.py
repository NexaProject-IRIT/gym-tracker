...
ФОРМАТ JSON-БЛОКА ТРЕНИРОВКИ (оборачивать ОБЯЗАТЕЛЬНО, когда просят составить тренировку):
...
Текст вокруг блока <workout> пользователь видит как обычное сообщение. JSON внутри блока используется системой для кнопки "Добавить тренировку".
"""
