...
#             if exercises_list:
#                 exercise_names = [(ex.name, ex) for ex in exercises_list]
#                 names_only = [name for name, _ in exercise_names]
...
#                     matched_ids.append(exercise_names[index][1].id)
#                 queryset = Exercise.objects.filter(id__in=matched_ids)
...
#             return Response([])
#         exercise_items = [(ex.name, ex) for ex in all_exercises]
...
#             return Response([])
#         equipment_items = [(eq.name, eq) for eq in all_equipment]
#         names_only = [name for name, _ in equipment_items]
#         results = process.extract(
#             q,
#             names_only,
